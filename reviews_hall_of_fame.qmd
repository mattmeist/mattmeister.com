...
reviews <- tibble::tibble(
  img = sprintf("reviews_hof/%03d.png", 1:12),
  context = c(
    ...
    "Here's the link, for those who need to zoom: https://g.co/kgs/fvoJrHT",
    "The recipe should have warned me not to 10x the peppers!"
  )
) |> dplyr::arrange(desc(img))
```
